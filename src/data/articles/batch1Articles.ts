  ...
  // 1. Grace Periods
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        alt: 'Examining credit card statement closing date and interest calculation breakdown',
        caption: 'Reviewing billing statement closing dates ensures you take full advantage of interest-free grace periods.',
        credit: 'Consumer Financial Bureau'
      },
      {
        id: 'b4',
        type: 'heading',
